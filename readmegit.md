...
git add .
git commit -m "decomposition des fichiers, mise a jour de l'archtecture"
...
│
├── css/
│   ├── style.css              # Fichier principal (importe tout)
│   ├── base.css               # Reset, variables, typo, animations
│   ├── layout.css             # Conteneurs, grilles, espacements
│   ├── components.css         # Boutons, cartes, navigation, formulaires
│   ├── sections.css           # Toutes les sections spécifiques
│   ├── utilities.css          # Classes helpers et responsive
