export function renderFooter() {
  return `
    <footer class="footer relative w-full bg-purple-900 text-gray-100 py-[60px]">
      <div class="container px-8 mx-auto max-w-7xl">
        <!-- 4 colonnes sur desktop, 1 colonne sur mobile -->
        <div class="grid grid-cols-1 gap-[60px] md:grid-cols-4 md:text-left text-center mb-[60px]">
          
          <!-- Colonne 1 : Brand -->
          <div class="footer-brand flex flex-col gap-[10px]">
          ...
          <div class="footer-links">
            <h4 class="block mb-4 text-[1.2rem] font-semibold text-white">Navigation</h4>
          ...
          <div class="footer-resources">
            <h4 class="block mb-4 text-[1.2rem] font-semibold text-white">Ressources</h4>
            <ul class="space-y-[5px] text-sm">
          ...
          <div class="footer-contact">
            <h4 class="block mb-4 text-[1.2rem] font-semibold text-white">Contact</h4>
            <div class="space-y-[10px] text-sm text-gray-100/70 flex flex-col items-center md:items-start">
              <ul class="space-y-[10px] text-sm text-gray-100/70">
                <li class="flex items-center justify-center md:justify-start gap-[10px]"><i class="fas fa-envelope text-gray-100 w-4"></i>peterleyauguste99@gmail.com</li>
                <li class="flex items-center justify-center md:justify-start gap-[10px]"><i class="fas fa-phone text-gray-100 w-4"></i>+509 41 97 53 92</li>
                <li class="flex items-center justify-center md:justify-start gap-[10px]"><i class="fas fa-map-marker-alt text-gray-100 w-4"></i>Port-de-Paix, Haïti</li>
              </ul>  
              <!-- Mentions légales (regroupées) -->
              <div class="mt-4 pt-4 border-t border-white/10 w-full">
                <ul class="space-y-[10px]">
                  <li><a href="#" class="inactive text-gray-100/70 hover:text-white transition-all duration-300 ease-in-out text-xs flex items-center justify-center md:justify-start gap-[10px] hover:pl-[5px]"><i class="ph ph-shield text-gray-100"></i>Mentions légales & CGV</a></li>
                  <li><a href="#" class="inactive text-gray-100/70 hover:text-white transition-all duration-300 ease-in-out text-xs flex items-center justify-center md:justify-start gap-[10px] hover:pl-[5px]"><i class="ph ph-lock text-gray-100"></i>Confidentialité</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <!-- Footer bottom -->
        <div class="footer-bottom flex flex-col items-center justify-center w-full pt-[40px] border-t border-white/10 md:flex-row md:justify-between gap-4 text-sm text-gray-100/70">
          <p class="mb-[5px]">&copy; 2026 Grade3.0 - Tous droits réservés.</p>
          <p class="mb-[5px]">Designé et développé avec <i class="fas fa-heart text-orange-600 animate-[heartbeat_1.5s_infinite]"></i> par Peterley Auguste</p>
