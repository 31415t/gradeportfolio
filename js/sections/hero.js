...
export function renderHero() {
  return `
    <section id="accueil" class="relative h-screen text-light overflow-hidden">
      ...
      <div class="relative z-20 flex flex-col justify-center items-center h-full text-center px-4 sm:px-6 md:px-8">
        <div class="max-w-4xl mx-auto">
          ...
          >
            <span class="block animate-bounce">Bienvenue dans</span>
            <span class="inline-block animate-bounce">ma gallerie de création</span>
          </h1>

          <!-- Subtitle -->
          <p class="text-base sm:text-lg md:text-xl text-gray-100 mb-6 sm:mb-8 leading-relaxed animate-fade-in-delayed">
            Je suis <span class="font-semibold">Peterley Auguste</span>, 
            <span class="block sm:inline">graphic designer freelance et fondateur de <span class="font-bold">Grade</span>, avec 5 ans d'expérience dans la création de supports visuels percutants (120+ projets réalisés).</span>
          </p>
